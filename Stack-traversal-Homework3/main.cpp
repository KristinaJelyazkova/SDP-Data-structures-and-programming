...
void testListCount() {
	...
	std::cout << count<ListIterator<int>, int>(it, 3) << std::endl;
}
...
void testListDuplicates() {
	...
	list.push(11);
	ListIterator<int> it = list.begin();
	std::cout << duplicates<ListIterator<int>, int>(it) << std::endl;
}
...
void testListIsSorted() {
	...
	list.push(43);
	ListIterator<int> it = list.begin();
	std::cout << isSorted<ListIterator<int>, int>(it) << std::endl;
}
...
void testListPalindrom() {
	...
	list.push(1);
	ListIterator<int> it = list.begin();
	std::cout << palindrom<ListIterator<int>, int>(it) << std::endl;
}

void testArrayCount() {
	int arr[4] = { 3, 2, 3, 3 };
	ArrayIterator<int> it(arr, 4);
	std::cout << count<ArrayIterator<int>, int>(it, 3) << std::endl;
}

void testArrayDuplicates() {
	int arr[10] = { 0, 2, 1, 8, 5, 1, 6, 3 };
	ArrayIterator<int> it(arr, 8);
	std::cout << duplicates<ArrayIterator<int>, int>(it) << std::endl;
}

void testArrayIsSorted() {
	int arr[4] = { 3, 5, 6, 7 };
	ArrayIterator<int> it(arr, 4);
	std::cout << isSorted<ArrayIterator<int>, int>(it) << std::endl;
}

void testArrayPalindrom() {
	int arr[10] = { 3, 5, 6, 7 , 10,  10,  7, 6, 5, 3};
	ArrayIterator<int> it(arr, 10);
	std::cout << palindrom<ArrayIterator<int>,int>(it) << std::endl;
}

void testStringCount() {
	char *str = "baklava";
	StringIterator<char> it(str);
	std::cout << count<StringIterator<char>, char>(it, 'a') << std::endl;
}

void testStringDuplicates() {
	char *str = "baklava";
	StringIterator<char> it(str);
	std::cout << duplicates<StringIterator<char>, char>(it) << std::endl;
}

void testStringIsSorted() {
	char *str = "ponmkgfedcbt";
	StringIterator<char> it(str);
	std::cout << isSorted<StringIterator<char>, char>(it) << std::endl;
}

void testStringPalindrom() {
	char *str = "babaabab";
	StringIterator<char> it(str);
	std::cout << palindrom<StringIterator<char>, char>(it) << std::endl;
}
