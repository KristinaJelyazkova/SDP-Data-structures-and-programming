...
//Äàäåíî å äâîè÷íî äúðâî îò ñèìâîëè.
struct TreeNode {
	char symbol;
	TreeNode *left, *right;
...
//Äà ñå íàïèøå ôóíêöèÿ, êîÿòî ïðîâåðÿâà äàëè ñúùåñòâóâà ïúò îò êîðåíà íà äúðâîòî 
//äî íåãîâî ëèñòî, çà êîéòî å èçïúëíåíî ñëåäíîòî óñëîâèå : 
//äóìàòà, êîÿòî ñå ôîðìèðà ïðè êîíêàòåíàöèÿ íà ñèìâîëèòå â ïúòÿ â ïîñîêà îò 
//êîðåíà íà äúðâîòî êúì ëèñòîòî, ñúâïàäà ñ äóìà, êîÿòî ñå ôîðìèðà îò åëåìåíòèòå 
//íà íÿêîå íèâî X â ñúùîòî äúðâî, ðàçãëåæäàíè îòëÿâî - íàäÿñíî.
