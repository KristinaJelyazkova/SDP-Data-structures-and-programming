//Да се създаде(чрез включване) двоично наредено дърво от интервали от числа([a, b], a <= b).
//Наредбата да е по дължината на интервала.
//Да се намери минималният интервал, съдържащ всички интервали на двоично - нареденото дърво.
